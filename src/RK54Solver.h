#ifndef EMBEDDED_METHODS_CPP_RK54SOLVER_H
#define EMBEDDED_METHODS_CPP_RK54SOLVER_H
#include "EmbeddedRungeKutta.h"

template<typename Scalar>
class RK54Solver : public EmbeddedRungeKutta<Scalar> {
protected:
    ...
    void makeStep() override {
        ...
        if (truncationError < this->_eps) {
            ...
            this->_y += ch1 * k1 + ch3 * k3 + ch4 * k4 + ch5 * k5 + ch6 * k6;
            this->_x += this->_h;
...
#endif //EMBEDDED_METHODS_CPP_RK54SOLVER_H
